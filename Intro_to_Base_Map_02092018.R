...
sites <- read_excel("Data/Intro_to_Base_Map_QWsitesformap.xlsx") #<- Excel sheet of lesson data qwsites
...
## Lesson Intro_to_Base_Map_QWsites.xlsx uses station id numbers not in Intro_to_Base_Map_QWsitesformap.xlsx

# Create variable to for Intro_to_Base_Map_QWsites.xlsx excel table
QWsites <- read_excel("Data/Intro_to_Base_Map_QWsites.xlsx", col_types = c(rep("text",3)))
